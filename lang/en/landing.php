...
return [
    ...
    'facts' => [
        ...
        'chip_hours' => '{1} one accredited training hour|[2,*] :count accredited training hours',
        'chip_remote' => 'Fully remote',
        'trust_weeks' => 'weeks of intensive training',
        'trust_sessions' => 'live sessions with the trainer',
        'trust_hours' => 'accredited training hours',
    ...
    'headings' => [
        ...
        'timeline' => [
            ...
            'lead' => 'The programme milestones and their dates, as fixed for the current cohort.',
            'registration_closes' => 'Registration closes',
            'intro_session' => 'Introductory session',
            'training_weeks' => 'Training weeks',
            'final_project' => 'Final project submission',
            'closing_session' => 'Closing ceremony',
        ],
        'certificates' => [
            'kicker' => 'Certificates',
