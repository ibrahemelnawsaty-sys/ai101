...
return [
    ...
    'login' => [
        ...
        'invitation_expired_title' => 'The temporary password has expired',
        'invitation_expired_body' => 'The password that reached you in the invitation has passed its window. Ask for a fresh link and set your own password in a minute.',
        'invitation_expired_action' => 'Ask for a recovery link',
    ...
    'first_password' => [
        ...
        'subtitle' => 'You signed in with a temporary password that reached you by e-mail. Choose your own to begin.',
        'required' => 'Choose your own password before using the platform.',
        'signed_in_as' => 'Signed in as',
        'current' => 'Temporary password',
        'current_hint' => 'The one that reached you in the invitation.',
        'new' => 'New password',
        'new_hint' => 'Eight characters or more, with an upper-case letter, a lower-case letter, a number and a symbol.',
        'confirm' => 'Type the new password again',
        'submit' => 'Save and begin',
        'expires_note' => 'The temporary password stops working on :date.',
        'sign_out' => 'Not you? Sign out',
        'expired_title' => 'The temporary password has expired',
        'expired_body' => 'The password that reached you has passed its window. Sign out, then ask for a fresh recovery link from the sign-in page — it arrives straight away.',
        'expired_action' => 'Sign out and ask for a new link',
        'expired_recover' => 'Enter your e-mail here and a link to set a new password will reach you.',
    ],
    'register' => [
