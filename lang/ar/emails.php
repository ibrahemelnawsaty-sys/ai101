...
return [
    ...
    */
     ...
     */
    'invitation_link' => [
        'subject' => 'دعوتك إلى :program',
        'preheader' => 'رابط الدعوة يفتح مرة واحدة، وفيه تختار كلمة مرورك.',
        'heading' => 'أهلًا بك — خطوة واحدة ويفتح حسابك',
        'body' => 'أُنشئ لك حساب في :program. اضغط الزر أدناه لتكمل بياناتك وتختار كلمة مرورك، ويفتح حسابك في الحال. هذا البريد هو اسم دخولك ولا يتغيّر.',
        'cta' => 'أكمل حسابي',
        'expiry_note' => 'الرابط يعمل مرة واحدة، وينتهي بعد مدّة محدودة. إن انتهى قبل أن تفتحه فراسل إدارة البرنامج ليصلك غيره.',
        'ignore_note' => 'إن وصلتك هذه الرسالة بالخطأ فتجاهلها، ولن يُستعمل الحساب.',
    ],
    ...
    */
    ...
    'attendance_exception_requested' => [
        'subject' => 'استلمنا طلب :type بعذر لجلسة :session',
        'preheader' => 'طلبك قيد المراجعة الآن.',
        'heading' => 'استلمنا طلبك',
        'body' => 'وصلنا طلبك بخصوص :type لجلسة :session، وهو الآن قيد مراجعة فريق البرنامج.',
        'cta' => 'افتح سجل حضوري',
    ],

    'attendance_exception_approved' => [
        'subject' => 'قُبل طلبك بخصوص جلسة :session',
        'preheader' => 'تحدَّث سجل حضورك.',
        'heading' => 'قُبل طلبك',
        'body' => 'قَبلنا طلبك بخصوص :type لجلسة :session، وتحدَّث سجل حضورك ليعكس ذلك.',
        'cta' => 'افتح سجل حضوري',
    ],

    'attendance_exception_rejected' => [
        'subject' => 'بخصوص طلبك عن جلسة :session',
        'preheader' => 'تفاصيل القرار.',
        'heading' => 'لم يُقبل طلبك',
        'body' => 'راجعنا طلبك بخصوص :type لجلسة :session ولم نتمكن من قبوله. السبب: :reason',
        'next_steps' => 'إن كان لديك ما تضيفه يمكنك مراسلتنا على :email.',
    ],
