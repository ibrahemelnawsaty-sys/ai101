...
return [
    ...
    'starts_in' => 'تبدأ بعد',
    'join' => 'دخول المحاضرة',
    'join_locked' => '{0} يُفتح الدخول عند بداية الجلسة، ولا يُرسل الرابط إلى متصفحك قبل ذلك.|{1} يُفتح الدخول قبل بداية الجلسة بدقيقة واحدة، ولا يُرسل الرابط إلى متصفحك قبل ذلك.|{2} يُفتح الدخول قبل بداية الجلسة بدقيقتين، ولا يُرسل الرابط إلى متصفحك قبل ذلك.|[3,10] يُفتح الدخول قبل بداية الجلسة بـ :minutes دقائق، ولا يُرسل الرابط إلى متصفحك قبل ذلك.|[11,*] يُفتح الدخول قبل بداية الجلسة بـ :minutes دقيقة، ولا يُرسل الرابط إلى متصفحك قبل ذلك.',
    'passcode' => 'كلمة مرور الاجتماع',
    'copy_passcode' => 'انسخ كلمة المرور',
    'passcode_copied' => 'نُسخت كلمة المرور',
