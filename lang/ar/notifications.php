    ...
    */
    ...
    'types' => [
        ...
        'session_changed' => [
            ...
            'body' => 'موعدها الجديد :datetime بتوقيت الرياض. راجع الجدول للتفاصيل.',
        ],
        'session_cancelled' => [
            'label' => 'إلغاء جلسة',
            'title' => 'أُلغيت جلسة :session',
            'body' => 'سبب الإلغاء: :reason. أي موعد بديل يظهر في جدولك.',
        ],
        ...
        'attendance_low' => [
            ...
            'body_final' => 'نسبتك :current% والحد المطلوب للشهادة :required%. لم تبقَ جلسات؛ إن كان غيابٌ ما بعذر فراجع به مدرّبك.',
        ],
        ...
        'certificate_issued' => [
            'label' => 'إصدار الشهادة',
            'title' => 'صدرت شهادتك',
            'body' => 'مبارك لك إتمام البرنامج. افتح شهادتك وشارك رابط التحقق من تبويب الشهادة.',
        ],
        'enrollment_approved' => [
