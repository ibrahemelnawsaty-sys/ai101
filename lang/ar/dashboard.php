...
return [
    ...
    'next_session' => [
        ...
        'starts_in' => 'تبدأ بعد',
        'join' => 'دخول المحاضرة',
        'join_locked' => 'الدخول لم يُفتح بعد',
        'link_hint' => '{0} يُفتح زر الدخول عند بداية الجلسة، ولا يظهر الرابط قبل ذلك.|{1} يُفتح زر الدخول قبل بداية الجلسة بدقيقة واحدة، ولا يظهر الرابط قبل ذلك.|{2} يُفتح زر الدخول قبل بداية الجلسة بدقيقتين، ولا يظهر الرابط قبل ذلك.|[3,10] يُفتح زر الدخول قبل بداية الجلسة بـ :minutes دقائق، ولا يظهر الرابط قبل ذلك.|[11,*] يُفتح زر الدخول قبل بداية الجلسة بـ :minutes دقيقة، ولا يظهر الرابط قبل ذلك.',
