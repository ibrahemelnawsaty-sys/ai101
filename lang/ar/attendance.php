...
return [
    ...
    */
    ...
    'checkin_code' => [
        ...
        // D-117 — المعاينة تنظر فقط، والرمز يسجّل حضور من يحمله.
        'preview_title' => 'رمز التحضير لا يظهر في وضع المعاينة',
        'preview_body' => 'الرمز يسجّل حضور أي متدرب يصله، فلا يُعرض أثناء معاينة حساب. يراه صاحب الحساب نفسه حين يفتح هذه الشاشة.',
    ],
