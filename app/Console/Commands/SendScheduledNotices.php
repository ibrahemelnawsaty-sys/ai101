 ...
 * and in six hours, to those who have not handed it in; and the final
 * project's six deadline reminders, to those who have not handed it in (D-122).
 *
...
final class SendScheduledNotices extends Command
{
    ...
    /** @var string */
    protected $description = 'Send the session, assignment and final project reminders that are due now.';
    ...
    public function handle(ScheduledNotices $notices): int
    {
        ...
        $this->components->info(sprintf(
            '%d session notice(s), %d assignment notice(s), %d final project notice(s).',
            $sent['sessions'],
            $sent['assignments'],
            $sent['final_projects'],
        ));
