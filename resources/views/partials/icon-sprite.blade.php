{{--
    Inline SVG sprite: brand wordmark, brand mark, UI icons.
    Source: docs/04-design/APPROVED-UI-showcase.html (approved by the product owner).
    Inlined so the public pages issue zero extra network requests (Constitution art. 19).
    @see PRD 9.1.3
--}}
