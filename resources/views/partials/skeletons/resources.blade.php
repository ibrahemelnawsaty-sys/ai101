{{--
    Loading skeleton — Training resources
    ...
    the type filter, then the resource cards with their file thumbnails.
    ...
    @see PRD §9.13 · CONSTITUTION Articles 17, 18
--}}
<div class="ui-sk-stack" data-state="loading" aria-busy="true">
    ...
    <div class="skel-cards" data-skeleton-block="cards">
        <x-ui.skeleton shape="card" :count="6" :lines="2" aria-hidden="true" />
    </div>
</div>
